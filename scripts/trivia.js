...
var triviaCategories = ['Anagrams', 'Anime/Manga', 'Animals', 'Art', 'Comics', 'Food/Drink', 'Games', 'Geography', 'History', 'Internet', 'Language', 'Literature', 'Math', 'Mental Math', 'Miscellaneous', 'Movies', 'Music', 'Mythology', 'Pokémon', 'Pokémon Online', 'Pokémon Without Vowels', 'Politics', 'Religion', 'Science', 'Social Science', 'Society', 'Space', 'Sports', 'Technology', 'Television', 'Video Games', 'Who\'s That Pokémon?'];
...
addAdminCommand("startvote", function (src, commandData, channel) {
    if (Trivia.started) {
        Trivia.sendPM(src, "A game is currently ongoing!", channel);
        return;
    }
    Trivia.startVoting();
...
}, "Shows the current leaderboard and your standing, format: /leaderboard [type]*[#]. Type is the scoring used (knowledge [know], elimination [elim], or speed); required. # is the number of places to show; if left blank, shows top 10 and your placement.");
